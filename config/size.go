...
// Code taken from
// https://github.com/kythe/kythe/blob/master/kythe/go/util/datasize/datasize.go
// in order to avoid importing the entire library...
...
// SizeFromString parses a Size from a string.  A Size is an unsigned decimal number with
