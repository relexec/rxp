...
// WithSystem is used to look up a Kind in a specific System. If no system
// identifier is specified, the host system responding to the KindRead request
// is used.
...
// WithName is used to look up a Kind with a specified Name.
