...
func GenerationEqual(generation core.Generation) query.Expression {
	return query.UnaryExpression{
...
// particular Generation.
func GenerationNotEqual(generation core.Generation) query.Expression {
	return query.UnaryExpression{
		Predicate: GenerationPredicate{
			query.BasePredicate{
				Op:      query.PredicateOperatorEqual,
...
func GenerationIn(generations ...core.Generation) query.Expression {
	// flatten IN to = when there's only one value...
...
func GenerationNotIn(generations ...core.Generation) query.Expression {
	return query.UnaryExpression{
		Predicate: GenerationPredicate{
			query.BasePredicate{
				Op:      query.PredicateOperatorIn,
